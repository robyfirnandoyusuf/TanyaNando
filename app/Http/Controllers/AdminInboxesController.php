...
class AdminInboxesController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
			...
			$this->col[] = ["label"=>"Chat Id","name"=>"chat_id"];
			$this->col[] = ["label"=>"Message Id","name"=>"message_id"];
		...
		$this->addaction[] = ['label' => 'Waiting', 'url' => CRUDBooster::mainpath('set-status/'.Inbox::WAITING.'/[id]'), 'icon' => 'fa fa-clock-o', 'color' => 'default'];
		$this->addaction[] = ['label' => 'Progress', 'url' => CRUDBooster::mainpath('set-status/'.Inbox::PROGRESS.'/[id]'), 'icon' => 'fa fa-clipboard'];
		$this->addaction[] = ['label' => 'Done', 'url' => CRUDBooster::mainpath('set-status/'.Inbox::DONE.'/[id]'), 'icon' => 'fa fa-check', 'color' => 'success'];
		$this->addaction[] = ['label' => 'Pending', 'url' => CRUDBooster::mainpath('set-status/'.Inbox::PENDING.'/[id]'), 'icon' => 'fa fa-times', 'color' => 'danger'];
	...
	public function hook_row_index($column_index, &$column_value)
	{
		//Your code here
		if ($column_index == 6)
			$column_value = Inbox::STATUS[$column_value];
	}
